...
class SendMessageIndividual extends Notification
{
    use Queueable;
        ...
        return (new MailMessage)
                ...
                ->markdown(
                    ...
                    [
                        ...
                        'employer' => !empty($this->sender) && $this->sender->hasRole('employer') ? $this->sender->company_name : ($this->sender->full_name ?? null)
                    ]
                );
    }
    ...
    {
        return str_replace(['@name', '@message'], [$notifiable->getName(), $this->object['message']], config('sms.contents.chat_content'));
    }
}
