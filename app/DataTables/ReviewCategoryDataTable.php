...
class ReviewCategoryDataTable extends BaseDataTable
{
    protected $repository;

    public function __construct(ReviewCategoryRepository $repository)
    {
    ...
    public function dataTable($query)
    {
        ...
        $action_view = view()->exists('review_categories.datatables_actions') ? 'review_categories.datatables_actions' : 'components.datatables_actions';
     ...
     *
     * @param \App\Models\ReviewCategory $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(ReviewCategory $model)
    {
    ...
    {
        return 'review_categories_datatable_' . time();
    }
}
