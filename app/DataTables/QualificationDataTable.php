...
class QualificationDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $action_view = view()->exists('qualifications.datatables_actions') ? 'qualifications.datatables_actions' : 'components.datatables_actions';
     ...
     */
    public function query(Qualification $model)
    {
    ...
    {
        return 'qualifications_datatable_' . time();
    }
}
