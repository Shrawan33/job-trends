...
class WorkTypeDataTable extends BaseDataTable
{
    protected $repository;

    public function __construct(WorkTypeRepository $repository)
    {
    ...
    public function dataTable($query)
    {
        ...
        $action_view = view()->exists('work_types.datatables_actions') ? 'work_types.datatables_actions' : 'components.datatables_actions';
    ...
    {
        return 'work_types_datatable_' . time();
    }
}
