...
class FunctionHelper
{
    ...
    {
        if (empty($entity)) {
            if ((request()->is('admin/*') || request()->is('mentor/*') || request()->is('account/*')) && is_string(request()->segment(2))) {
    ...
    public static function prepareProfilPdf($input, $view, $encode = true, $download = false, $name = '')
    {
        $options = [
            'orientation' => 'portrait',
            'encoding' => 'UTF-8',
