...
class CreateEmployerJobQualificationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employer_job_qualifications', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('employer_job_qualifications');
    }
}
