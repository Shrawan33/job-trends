...
class CreateEmployerJobWorkTypeTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('employer_jobs_work_type', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('employer_jobs_work_type');
    }
}
