...
<div id="{{ $dropzone_id }}">
    ...
    <div class="form-group position-relative file-upload mb-0">
        <label for=""
            class="max-auto d-flex align-items-center flex-column justify-content-center px-3 py-2 fileinput-button-basic-video dz-clickable"><svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 50 50" fill="none">
            ...
            <label for="" class="text-primary font-weight-bold py-2 mb-0 fileinput-button-basic-video dz-clickable"><?php echo $link_text ??
    ...
    <script>
        ...
        $(document).ready(function() {
            $("div#{{ $dropzone_id }}").dropzone({
                ...
                clickable: ".fileinput-button-basic-video",
                headers: {
