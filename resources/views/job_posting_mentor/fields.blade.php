...
<!-- Work Type Id Field -->
<div class="form-group mb-4">
    {!! Form::label('work_type_id', trans('label.job_type')) !!}
    {!! Form::select('work_type_id', $workTypes??[], $workTypesids, ['class' => 'form-control '. (isset($errors) &&
...
{!! Form::hidden('job_type_id', $job_type_id) !!}
{!! Form::hidden('approve_job', 1) !!}

<!-- Skill Id  Field -->
<div class="form-group mb-4">
    <label for="">{{trans('label.skills')}} *</label>
...
<div class="form-group mb-4">
    {!! Form::label('certification_id', trans('label.licence_and_certification')) !!}
    {!! Form::select('certification_id[]', $certifications??null, $certificationids, ['class' => 'form-control', 'data-placeholder' =>  trans('label.certification'), 'multiple'=>true]) !!}
</div>

<!-- Experience Id Field -->
<div class="form-group mb-4">
    {!! Form::label('experience_id', trans('label.experience_in_year')."*") !!}
    {!! Form::select('experience_id', $experinces??[], null, ['class' => 'form-control', 'data-placeholder' => trans('label.experience_in_year')]) !!}
</div>

<!-- Skill Id  Field -->
<div class="form-group mb-4">
    {!! Form::label('qualification_id', trans('label.education')."*") !!}
    {!! Form::select('qualification_id[]', $qualifications??null, $qualificationIDS, ['class' => 'form-control', 'data-placeholder' => trans('label.education'), 'multiple'=>true]) !!}
</div>

<div class="form-group mb-4">
    {!! Form::label('other_recuirements', 'Other Requirement',['class' => 'required-label']) !!}
    {!! Form::textarea('other_recuirements', null, ['rows' => 4,'class' => 'form-control '. ($errors->has('other_recuirements') ? 'is-invalid' : ''), 'placeholder' =>trans('label.job_detail_page.other_recuirements'), 'richtexteditor' => true]) !!}
...
<div class="form-group mb-4">
    <label for="">{{trans('label.area')}}</label>
    {!! Form::text('area', old('area', $employerJob->area ?? null), ['class' => 'form-control', 'placeholder' => trans('label.area')]) !!}
    @error('area')
        <span class="error invalid-feedback">{{ $message }}</span>
    @enderror
</div>
...
<div class="form-group mb-4">
    <div class="d-flex align-items-center">
        {!! Form::checkbox('is_urgent', 1, null, ['class' => '']) !!} {{trans('label.is_urgent')}}
    </div>
</div>
<div class="form-group mb-4">
    <label for="">{{trans('label.expiration_date')}}</label>
