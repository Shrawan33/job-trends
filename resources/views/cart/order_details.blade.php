...
<div class="container order_detail_main_wraper">
    <div class="d-flex align-items-center mb-30 justify-content-between flex-wrap">
    <h2 class="title_heading mb-0">{{trans('label.customer_details')}}</h2>
    <a href="{{ route('orderHistory.download-orders', $order->id) }}" class="btn btn-primary ml-auto btn-sm">
        ...
        <div class="col-lg-8">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-8">
                    <p class="info mb-24"><b>{{ $order->user_info['first_name'] }} {{ $order->user_info['last_name'] }} </b></p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-2 col-md-4 pr-0">
                ...
                <div class="col-lg-4 col-md-8">
                    <p class="info mb-24">{{ $order->user_info['email'] }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-2 col-md-4 pr-0">
                ...
                <div class="col-lg-4 col-md-8">
                    <p class="info mb-24">{{ $order->user_info['phone_number'] }}</p>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-2 col-md-4 pr-0">
                ...
                <div class="col-lg-4 col-md-8">
                    <p class="info mb-24">{{ $order->short_address }}</p>
                </div>
            </div>
        </div>
        <div class="col-lg-4">
            <div class="row">
                ...
                <div class="col-md-4 text-lg-right">
                    <p class="info mb-24"><b>{{ $order->order_number }}</b></p>
                </div>
            </div>
        </div>
    </div>

    <h2 class="title_heading mb-30">{{trans('label.package_details')}}</h2>
    <div class="table-responsive package_detail_table_wraper">
        <table class="package_detail_table" width="100%">
            <thead>
                <tr>
                    <th width="30%">{{trans('label.name')}}</th>
                ...
                @if ($order)
                    @foreach ($order->item_info as $item)
                        ...
                        <tr>
                            ...
                            <td>₹ {{ $item['price'] ?? '' }}</td>
                            <td>{{ $item['quantity'] ?? ''}}</td>
                            <td class="text-secondary text-right">₹ {{$item['price'] * $item['quantity']}}</td>
                        </tr>
                    @endforeach
                @endif
                    ...
                    <td colspan="4" align="right" class="p-0">
                        <table width="20%">
                            ...
                            <tr>
                                ...
                                <td align="right" class="text-secondary">₹ {{ $order->total_amount }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <h2 class="title_heading mb-30">{!! trans('label.additional_information') !!}</h2>
    ...
    <h2 class="title_heading mb-50">Comments</h2>
    <p class="comments d-flex mb-30">
        <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 18 18" fill="none">
            <g clip-path="url(#clip0_1018_1178)">
                <path d="M11.6719 1.96875H6.32812C3.22147 1.96875 0.703125 4.4871 0.703125 7.59375C0.703125 10.7003 3.22147 13.2188 6.32812 13.2188H7.45312C8.2298 13.2188 8.85938 13.8483 8.85938 14.625V16.0312C14.6939 12.3191 17.2603 11.3831 17.2965 7.67384C17.2967 7.64722 17.2969 7.62054 17.2969 7.59375C17.2969 4.48713 14.7785 1.96875 11.6719 1.96875Z" stroke="#FF7D57" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M6.32812 6.1875H11.6719" stroke="#FF7D57" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
                <path d="M11.6719 9H6.32812" stroke="#FF7D57" stroke-width="1.5" stroke-miterlimit="10" stroke-linecap="round" stroke-linejoin="round"/>
            </g>
            <defs>
                <clipPath id="clip0_1018_1178">
                <rect width="18" height="18" fill="white"/>
                </clipPath>
            </defs>
        </svg>
        <span class="ml-12">{{ $order->user_info['comment'] }}</span>
    </p>
</div>
@endsection
