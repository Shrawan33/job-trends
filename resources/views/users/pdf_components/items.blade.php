                ...
                <tr>
                    <td style="padding:0 20px; vertical-align:top">
                        ...
                        <h2
                            ...
                            {{ $input->full_name ?? 'no-data' }}</h2>
                        @if (!empty($input->seekerDetail))
                            <p
                                style="font-family: 'Helvetica', sans-serif; font-size:16px; margin-bottom:8px; margin-top: 0;">
                                <?php
                                if (isset($input->job_title) && isset($input->seekerDetail->current_company)) {
                                    echo $input->job_title . ' | ' . $input->seekerDetail->current_company;
                                } elseif (isset($input->job_title)) {
                                    echo $input->job_title;
                                } elseif (isset($input->seekerDetail->current_company)) {
                                    echo $input->seekerDetail->current_company;
                                } else {
                            ...
                            <p
                                ...
                                {{ $input->seekerDetail->total_experience . ' Years Experience' ?? '' }}</p>
                            <p
                                style="font-family: 'Helvetica', sans-serif; font-size:16px; margin-bottom: 10px; margin-top: 0;">
                            ...
                            @role('jobseeker')
                                @if ($input->seekerDetail->is_public_profile == 1)
                                    <p
                                        style="font-family: 'Helvetica', sans-serif; font-size:16px; margin-bottom:10px; margin-top: 0;">
                                        Mobile:
                                        <a class="text-body"
                    ...
                    <td style="padding:0 20px; vertical-align:top">
                        ...
                        @if (isset($input->seekerDetail))
                            <div style="width: 100%; float: left;">
                                ...
                                @endif --}}
                                @if (!empty($input->seekerDetail->dob))
                                    <div style="width: 30%; float: left; padding-right: 10px; margin-bottom: 20px;">
                                        <h6
                                        ...
                                        <p
                                            style="font-family: 'Helvetica', sans-serif; font-size:16px; margin-bottom:10px; color: #000; margin-top: 0;">
                                            {{ isset($input->seekerDetail->dob) ? FunctionHelper::fromSqlDate($input->seekerDetail->dob->toDateString(), true, 'd M, Y') : null }}
                                        </p>
                                    </div>
                                @endif
                                ...
                                @if (!empty($input->seekerDetail->marital_status))
                                    <div style="width: 30%; float: left; padding-right: 10px; margin-bottom: 20px;">
                                        <h6
                                            style="font-family: 'Helvetica', sans-serif; color: #a5a5a5 !important;font-weight: 600 !important; margin-bottom: 8px; font-size: 15px; margin-top: 0;">
                                        ...
                                        <p
                                            ...
                                            {{ config("constants.marital_status." . $input->seekerDetail->marital_status, '-') }}
                                        </p>
                                    </div>
                                @endif
