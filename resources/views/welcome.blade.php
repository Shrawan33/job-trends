...
@section('content')
    ...
    {{-- @guest
        <div class="" id="explore_job_section">
            <h2 class="explore_job font-weight-bold f-30 text-primary m-0 d-flex align-items-center justify-content-center active">
    ...
    @endrole --}}
    <div class="page_content_main_wraper active">

         <div class="banner_top_wraper position-relative">
        <div class="home_main_baneer" style="margin-top:183px">
