    ...
    <div class="container my-5 event_main_wraper">
        <div class="job_top_banner bg_frame position-relative py-30 py-lg-60">
            ...
            <div class="position-relative">
                <h1 class="mb-4 text-center position-relative text-white">{{ trans('label.events') }}</h1>
            ...
            @foreach ($events as $event)
                <div class="col-md-6 col-lg-4 mb-40">
                    <div class="inner_wraper p-15 p-lg-20 h-100">
                        ...
                        <a class="box_title d-flex align-items-center justify-content-between" href="{{ route('eventShow', ['event' => $event->id]) }}">
                                {{ $event->event_title }}
                        ...
                        <div class="mb-30 box_desc">{!! $event->small_description !!}</div>
