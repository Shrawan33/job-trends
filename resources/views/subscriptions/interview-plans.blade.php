...
@section('content')
    <div class="container plan_package_main_wraper detail_page">
        <div class="package_heading_wraper pt-20 text-center">
            <h1 class="title mb-30">{{ trans('label.interview_service') }}</h1>
            <div class="description mb-60">{{ trans('message.interview_text') }}</div>
        </div>
        <div class="row mb-40">
            @foreach ($items as $item)
                <div class="col-md-6 col-lg-4 mb-40">
                    <div class="plan-box p-20 detail_box p-lg-30 h-100 d-flex flex-column">
                        ...
                        <a href="{{ route('add-item-to-cart', $item->id) }}" class="btn btn-primary w-100 mt-auto">
