...
function websdkready() {
  ...
  var API_KEY = "w307px9kT9unZdaqrrwdyQ";
   ...
   */
  var API_SECRET = "2vXrXiKGJSjRbukMuB47khefxEJoJAM6khbU";
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/zoom-web-app/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
